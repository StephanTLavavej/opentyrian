...
void JE_playerMovement( Player *this_player, JE_byte inputDevice_, JE_byte playerNum_, JE_word shipGr_, Sprite2_array *shipGrPtr_, JE_word *mouseX_, JE_word *mouseY_ );
